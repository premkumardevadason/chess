...
/**
 * Standalone test for Double Ratchet encryption without Spring context
 */
public class StandaloneMCPDoubleRatchetTest {
    
    private static final Logger logger = LogManager.getLogger(StandaloneMCPDoubleRatchetTest.class);
    
    private MCPDoubleRatchetService doubleRatchetService;
    
    @BeforeEach
    void setUp() {
        // Create service directly without Spring
        doubleRatchetService = new MCPDoubleRatchetService();
        
        // Use reflection to set encryption enabled for testing
        try {
